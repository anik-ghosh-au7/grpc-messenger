...
const (
	ChatApi_Connect_FullMethodName    = "/main.ChatApi/Connect"
	ChatApi_Broadcast_FullMethodName  = "/main.ChatApi/Broadcast"
	ChatApi_GetClients_FullMethodName = "/main.ChatApi/GetClients"
)
...
func (c *chatApiClient) Connect(ctx context.Context, in *User, opts ...grpc.CallOption) (ChatApi_ConnectClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatApi_ServiceDesc.Streams[0], ChatApi_Connect_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatApiClient) Broadcast(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, ChatApi_Broadcast_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatApiClient) GetClients(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ClientList, error) {
	out := new(ClientList)
	err := c.cc.Invoke(ctx, ChatApi_GetClients_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatApi_Broadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatApi_Broadcast_FullMethodName,
	}
...
func _ChatApi_GetClients_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatApi_GetClients_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
